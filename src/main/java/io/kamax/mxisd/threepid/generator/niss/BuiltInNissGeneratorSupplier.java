...
package io.kamax.mxisd.threepid.generator.niss;
...
public class BuiltInNissGeneratorSupplier implements NissGeneratorSupplier {

    @Override
    public Optional<NissGenerator> apply(PhoneConfig cfg, Mxisd mxisd) {
