...
public class NissSmsTwilioConnector implements NissConnector {

    public static final String ID = "twilio";

    private transient final Logger log = LoggerFactory.getLogger(NissSmsTwilioConnector.class);

    private NissTwilioConfig cfg;

    public NissSmsTwilioConnector(NissTwilioConfig cfg) {
        this.cfg = cfg.build();
